...
enum delta_result_type do_add_delta(conn *c, const char *key,
                                    ...
                                    item **it_ret);
enum delta_result_type do_multiply_by(conn *c, const char *key,
                                      const size_t nkey, const int64_t delta, char *buf,
                                      uint64_t *cas, const uint32_t hv, item **it_ret);
enum delta_result_type do_divide_by(conn *c, const char *key,
                                    const size_t nkey, const int64_t delta, char *buf,
                                    uint64_t *cas, const uint32_t hv, item **it_ret);
...
enum delta_result_type add_delta(conn *c, const char *key,
                                 ...
                                 const int64_t delta, char *buf,
                                 uint64_t *cas);
enum delta_result_type multiply_by(conn *c, const char *key,
                                   const size_t nkey, const int64_t b,
                                   char *buf, uint64_t *cas);
enum delta_result_type divide_by(conn *c, const char *key,
                                 const size_t nkey, const int64_t b,
                                 char *buf, uint64_t *cas);
